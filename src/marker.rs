...
/// type casually.
///
/// **Reminder:** The results of casting around bits and bytes between data
/// types are _endian dependant_. Little-endian machines are the most common,
/// but big-endian machines do exist (and big-endian is also used for "network
/// order" bytes).
///
/// ## Safety
///
